...
parser.add_argument('--data_dir', type=str, default='dataset/definition/merged-clipped')
parser.add_argument('--vocab_dir', type=str, default='dataset/definition/merged-clipped/vocab')
